...
import Streamly.Internal.Data.MutArray qualified as MArray
import Streamly.Internal.Data.Parser qualified as Parser
import Streamly.Internal.Data.ParserK qualified as ParserK
...
parseFixedSizeAndContinueWith
    :: Int -> (Array.Array Word8 -> StreamOfBytesParser) -> StreamOfBytesParser
